...
parser.add_argument('--noise_dir', default=r'C:\Users\T490s\Documents\GitHub\Speech-enhancement\Train\noise', type=str)

parser.add_argument('--voice_dir', default=r'C:\Users\T490s\Documents\GitHub\Speech-enhancement\Train\clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default=r'C:\Users\T490s\Documents\GitHub\Speech-enhancement\Train\spectrogram', type=str)

parser.add_argument('--path_save_time_serie', default=r'C:\Users\T490s\Documents\GitHub\Speech-enhancement\Train\time_serie', type=str)

parser.add_argument('--path_save_sound', default=r'C:\Users\T490s\Documents\GitHub\Speech-enhancement\Train\sound', type=str)
